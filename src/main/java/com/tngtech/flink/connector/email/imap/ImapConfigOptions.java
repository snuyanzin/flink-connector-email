...
public class ImapConfigOptions {
    ...
    public static final ConfigOption<String> FOLDER = ConfigOptions.key("folder").stringType().defaultValue("INBOX");

    // ---------------------------------------------------------------------------------------------

    public static final ConfigOption<StartupMode> MODE = ConfigOptions
        .key("mode")
    ...
    public static final ConfigOption<Long> OFFSET = ConfigOptions
        .key("offset")
        .longType()
        .noDefaultValue()
        .withDescription(
    ...
    public static final ConfigOption<Duration> INTERVAL = ConfigOptions
        .key("interval")
        .durationType()
        ...
        .withDescription(
            Description
                ...
                .linebreak()
                .text("This interval is only used if the server doesn't support IDLE. In this case, the connector falls back to polling.")
                .build()
        );
    ...
    public static final ConfigOption<Duration> HEARTBEAT_INTERVAL = ConfigOptions
        ...
        .withDescription("Frequency with which to send a heartbeat signal to maintain the IDLE connection.");
